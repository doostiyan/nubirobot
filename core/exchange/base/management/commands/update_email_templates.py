...
class Command(BaseCommand):
    help = 'Updates email templates based on base/templates/emails html templates'

    @staticmethod
    def get_email_template_path(email_name):
        path = os.path.join(settings.BASE_DIR, f'exchange/base/templates/emails/{email_name}.html')
    ...
    def handle(self, *args, **kwargs):
        ...
        for email_name, email_content in email_names.items():
