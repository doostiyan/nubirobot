...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--template', type=str, help='Template Debug Case', nargs='?',
                            default='set_anti_phishing_code')
        parser.add_argument('--data', type=str, help='Data Debug Case', nargs='?',
                            default={'anti_phishing_code': 'jgghfhfhfd'})
