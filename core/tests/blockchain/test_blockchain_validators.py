...
def test_validate_crypto_address():
    ...
    # USDT
    assert validate_crypto_address('0x9824742b36b2ddf54e67c665b14a8d0095aa5b6e', Currencies.usdt, 'ETH')
    assert not validate_crypto_address('0x9824742b36b2ddf54661q165b14a8d0095aa5b6e', Currencies.usdt, 'ETH')
    # OMNI USDT
...
def test_btc_address_validation_v2():
    ...
    assert validate_crypto_address_v2('bc1q fggp vs6f rqsj jnnds xsq3 kvqq 66qr 8ztp gv8lt', Currencies.btc) == (False, None)
    # Checksum invalid
...
def test_ltc_address_validation_v2():
    ...
    assert validate_crypto_address_v2('ltc1 qlz0y4 u47lcg 5uj7ylw5k2 8v68zun6prk70gdx5', Currencies.ltc) == (False, None)
    # Invalid addresses
...
def test_bch_address_validation_v2():
    ...
    # Incorrect addresses
    assert validate_crypto_address_v2('simpleledger:qq3eu2e94gr3sxlmueny3wttlyd6xv6qnvyhplwydn', Currencies.bch) == (False, None)
    assert validate_crypto_address_v2('bitcoincash:qqrxa0h9jqnc7v4wmj9ysetsp3y7w9l36u8gnnjulq', Currencies.bch) == (False, None)
    assert validate_crypto_address_v2('bitcoincash:qq3eu2e94gr3sxlmueny3wttlyd6xv6qnvgv2ymynd', Currencies.bch) == (False, None)
    ...
    assert validate_crypto_address_v2('bitcoincash:qq3eu2e94gr3sxlmueny3wttlyd6xv6qnv3y5av3cm', Currencies.bch) == (False, None)
    assert validate_crypto_address_v2('simpleledger:qq3eu2e94gr3sxlmueny3wttlyd6xv6qnv3y5av3cm', Currencies.bch) == (False, None)
...
def test_xlm_address_validation_v2():
    # Correct addresses
    assert validate_crypto_address_v2('GDY25GPB4E5JKWX7ZWQV6SHVAK4OLKKRGBJZ5X2E3BVW3XKE7XWRZ2PH', Currencies.xlm) == (True, 'XLM')
    assert validate_crypto_address_v2('GAHK7EEG2WWHVKDNT4CEQFZGKF2LGDSW2IVM4S5DP42RBW3K6BTODB4A', Currencies.xlm) == (True, 'XLM')
    assert validate_crypto_address_v2('GAEI6QWF4KJLL2XLMFHLO5EQZY3GVYRWVTCX3AJQVSUOXXPZWBA7DWVW', Currencies.xlm) == (True, 'XLM')
    # Incorrect addresses
    assert validate_crypto_address_v2('GAEI6QWF4KJLL2XLMFHLO5EQZY3GVYRWVTCX3AJQVSUOXXPZWBA7DWVY', Currencies.xlm) == (False, 'XLM')
    assert validate_crypto_address_v2('GAHK7EEG2WWH  VKD NT4C EQFZGKF 2LGDSW2IVM4S5DP42RBW3K6BTODB4A', Currencies.xlm) == (False, None)
    assert validate_crypto_address_v2('GAEI6QWF4KJLQ2XLMFHLO5EQZY3GVYRWVTCX3AJQVSUOXXPZWBA7DWVY', Currencies.xlm) == (False, 'XLM')
    assert validate_crypto_address_v2(' AEI6QWF4KJLQ2XLMFHLO5EQZY3GVYRWVTCX3AJQVSUOXXPZWBA7DWVY', Currencies.xlm) == (False, None)
    assert validate_crypto_address_v2('XGAEI6QWF4KJLQ2XLMFHLO5EQZY3GVYRWVTCX3AJQVSUOXXPZWBA7DWVY', Currencies.xlm) == (False, None)
    assert validate_crypto_address_v2('AEI6QWF4KJLQ2XLMFHLO5EQZY3GVYRWVTCX3AJQVSUOXXPZWBA7DWVY', Currencies.xlm) == (False, None)
...
def test_dot_address_validation_v2():
    # DOT
    # Correct addresses
    assert validate_crypto_address_v2('13ALHq3vrN9Mwx3UzZnbon2oA33TfM9nepPNZQ1yWnfyUqer', Currencies.dot) == (True, 'DOT')
    # Incorrect addresses
    assert validate_crypto_address_v2('5EcQKVbvPRaJ8kvhxgTcqUnmcbX2HjqMm7JXQ7WifK1xHpKA', Currencies.dot) == (False, None)
    assert validate_crypto_address_v2('13ALHq3vrN9Mwx3UzZnbon2oA33TfM9nepPNZQ1yWnfyUqes', Currencies.dot) == (False, 'DOT')
    assert validate_crypto_address_v2('13ALHq3vrN9Mwx3UzZnbon2oA33TfM9nepPNZQ1yWnfyU', Currencies.dot) == (False, 'DOT')
    assert validate_crypto_address_v2('23ALHq3vrN9Mwx3UzZnbon2oA33TfM9nepPNZQ1yWnfyUqes', Currencies.dot) == (False, None)
...
def test_ada_address_validation_v2():
    # ADA
    # Correct addresses
    assert validate_crypto_address_v2('addr1qxqs59lphg8g6qndelq8xwqn60ag3aeyfcp33c2kdp46a09re5df3pzwwmyq946axfcejy5n4x0y99wqpgtp2gd0k09qsgy6pz', Currencies.ada) == (True, 'ADA')
    assert validate_crypto_address_v2('addr1vxw96rx9arvgem7vhdgv3a9u8na07nynhyj7wfn3w96rtggvzfqeq', Currencies.ada) == (True, 'ADA')
    assert validate_crypto_address_v2('addr1v8v3auqmw0eszza3ww29ea2pwftuqrqqyu26zvzjq9dt2ncydzvs5', Currencies.ada) == (True, 'ADA')
    assert validate_crypto_address_v2('addr1qy9zqj47wzuquzn90w7hyy72gwzgnnea8gn4xyumplyeg5w8xcp8lda6wtjw9mfvqrpvkhpfj3ttp83tfqtl0f3wrj2qzr39jf', Currencies.ada) == (True, 'ADA')
    assert validate_crypto_address_v2('addr1q8m5asyuttv7n83vzdm6zaxzguszex0lqeygg8rekuzwu0k8xcp8lda6wtjw9mfvqrpvkhpfj3ttp83tfqtl0f3wrj2qjl5shp', Currencies.ada) == (True, 'ADA')
    assert validate_crypto_address_v2('addr1q80tw7ltwly4rv95urntqx4p3pyl0vgeurt2ntverdv48ve4yephjk97t6qnqncgcrk6sfrf9449u3tcg8wlk6dtt7jsqna6gj', Currencies.ada) == (True, 'ADA')
    assert validate_crypto_address_v2('DdzFFzCqrht4koJ4XsK91ZFTNGDaA8rLgoks5Qy6zTAwDfL2JjdNpmaezDuQEnptoov81kAj5TmQicT9ty7gon35TDub5dGLgWzi9Nco', Currencies.ada) == (True, 'ADA')
    # Incorrect addresses
    assert validate_crypto_address_v2('addr1qxqs59lphg8g6qndelq8xwqn60ag3aeyfcp33c2kdp46a09re5df3pzwwmyq946axfcejy5n4x0y99wqpgtp2gd0k09qsgy6pt', Currencies.ada) == (False, 'ADA')
    assert validate_crypto_address_v2('addrqxqs59lphg8g6qndelq8xwqn60ag3aeyfcp33c2kdp46a09re5df3pzwwmyq946axfcejy5n4x0y99wqpgtp2gd0k09qsgy6pz', Currencies.ada) == (False, 'ADA')
    assert validate_crypto_address_v2('addr1qxqs59lphg8g6qndelq8xwqn60ag3aeyfcp33c2kdp46a09re5df3pzwwmyq946axfcejy5n4x0y99wqpgtp2gd0k09', Currencies.ada) == (False, 'ADA')
...
@pytest.mark.unit
def disabled_test_testnet_validation():
    assert validate_crypto_address_v2('5EcQKVbvPRaJ8kvhxgTcqUnmcbX2HjqMm7JXQ7WifK1xHpKA', Currencies.dot) == (True, 'DOT')
    assert validate_crypto_address_v2('13ALHq3vrN9Mwx3UzZnbon2oA33TfM9nepPNZQ1yWnfyUqer', Currencies.dot) == (False, None)
    assert validate_crypto_address_v2('5EcQKVbvPRaJ8kvhxgTcqUnmcbX2HjqMm7JXQ7WifK1xHpKB', Currencies.dot) == (False, 'DOT')
    assert validate_crypto_address_v2('5EcQKVbvPRaJ8kvhxgTcqUnmcbX2HjqMm7JXQ7WifK1x', Currencies.dot) == (False, None)
    assert validate_crypto_address('tbnb1a3qrp4wpqesxfk9pd9tl7udq5rwte3m30de0nc', Currencies.bnb)
    assert not validate_crypto_address('tbnb1990lfutz0f9wza6rsh36ysfwt9xpctxrll884r', Currencies.bnb)
    assert validate_crypto_address('5EcQKVbvPRaJ8kvhxgTcqUnmcbX2HjqMm7JXQ7WifK1xHpKA', Currencies.dot)
    assert not validate_crypto_address('13ALHq3vrN9Mwx3UzZnbon2oA33TfM9nepPNZQ1yWnfyUqer', Currencies.dot)
    assert not validate_crypto_address('5EcQKVbvPRaJ8kvhxgTcqUnmcbX2HjqMm7JXQ7WifK1xHpKB', Currencies.dot)
    assert not validate_crypto_address('5EcQKVbvPRaJ8kvhxgTcqUnmcbX2HjqMm7JXQ7WifK1x', Currencies.dot)
    assert validate_crypto_address('tbnb1a3qrp4wpqesxfk9pd9tl7udq5rwte3m30de0nc', Currencies.bnb)
    assert not validate_crypto_address('tbnb1990lfutz0f9wza6rsh36ysfwt9xpctxrll884r', Currencies.bnb)
