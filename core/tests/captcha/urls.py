...
urlpatterns = [
    ...
    re_path(r'test2/$', test_custom_error_message, name='captcha-test-custom-error-message'),
    ...
    re_path(r'test-non-required/$', test_non_required, name='captcha-test-non-required'),
    re_path(r'test-id-prefix/$', test_id_prefix, name='captcha-test-id-prefix'),
    re_path(r'', include('exchange.captcha.urls')),
]
