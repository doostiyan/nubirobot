...
class FTMContractBalanceCheckerParserV2(ContractBalanceCheckerParserV2):
    network_config = BalanceCheckerConfig.FTM
...
class FTMContractBalanceCheckerV2Api(ContractBalanceCheckerV2):
    parser = FTMContractBalanceCheckerParserV2
    network_config = BalanceCheckerConfig.FTM
