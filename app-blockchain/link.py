...
class ChainLinkBlockchainInspector(Erc20BlockchainInspector, Bep20BlockchainInspector, OperaFTMBlockchainInspector,
    ...
    currency = Currencies.link
    currency_list = [Currencies.link]
