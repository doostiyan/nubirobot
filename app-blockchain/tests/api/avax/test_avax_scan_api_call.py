...
from exchange.blockchain.api.avax.avax_scan import AvaxScanApi
from exchange.blockchain.tests.fixtures.avax_fixtures import (
    block_number,
    tx_hash_successful,
    wallet,
)
...
@pytest.mark.slow
def test__scan_avax_api_call__get_wallet_txs__successful(wallet):
    expected_keys = {
...
@pytest.mark.slow
def test__scan_avax_api_call__get_block_txs__successful(block_number):
    required_keys = {
