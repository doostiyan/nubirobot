...
from exchange.blockchain.api.algorand.algorand_pure_stake import PureStakeAlgorandApi


@pytest.mark.slow
class TestPureStakeAlgorandApiCalls(TestCase):
    api = PureStakeAlgorandApi
...
class TestPureStakeAlgorandFromExplorer(TestCase):
    api = PureStakeAlgorandApi
