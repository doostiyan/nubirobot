...
from exchange.blockchain.api.algorand.algorand_algonode import AlgoNodeAlgorandApi
...
@pytest.mark.slow
class TestAlgoNodeAlgorandApiCalls(TestCase):
    api = AlgoNodeAlgorandApi
...
class TestAlgoNodeAlgorandFromExplorer(TestCase):
    api = AlgoNodeAlgorandApi
