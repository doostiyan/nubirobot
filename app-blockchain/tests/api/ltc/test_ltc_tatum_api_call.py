...
@pytest.mark.slow
def test__tatum_ltc__get_tx_details__api_call__successful(tx_hash, tx_hash_aggregation):
    tx_details_keys = {'blockNumber', 'fee', 'hash', 'inputs', 'outputs', 'time'}
    tx_details_keys_types = [('blockNumber', int), ('fee', str), ('hash', str), ('inputs', list),
    ...
    output_key_stypes = [('value', str), ('script', str), ('address', str)]
