...
@pytest.fixture
def rpc_transactions_details() -> dict:
    return {
...
@pytest.fixture
def rpc_transaction_receipt() -> dict:
    return {
        "0x07db627ee808d61f60872cab0c43b00083c573f6b0850e086a7c5e73002f5f83": {
            "result": {
...
@pytest.fixture
def rpc_address_transactions() -> dict:
    return {
        'message': 'OK',
        'result': [{
            'blockHash': '0xc30158b0aaf5e3d2b81174ce76526f219ca1be08e522a4702071f4271bdc6507',
            'blockNumber': '3818041',
            ...
            'gasUsed': '21000',
            'hash': '0xbb6a9b7b2b39246ec99da8e84cd84976e7a92cff29d0c1fb27b12d7405b2dcc7',
            'input': '0x',
            'isError': '0',
            'timeStamp': '1736820957',
            'to': '0x1c05a8583db5bfe954e9e1c705554517e0590e62',
            'txreceipt_status': '1',
            'value': '1039478500000000',
        }],
        'status': '1',
    }
